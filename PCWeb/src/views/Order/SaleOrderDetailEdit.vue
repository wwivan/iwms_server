        ...
        <el-form label-width="120px"
            ...
            <el-tabs value="basic"
                ...
                <el-tab-pane label="基本信息"
                             name="basic">
                    <el-form-item label="销售单号" v-if="this.model.orderNo">
                        <el-input v-model="model.orderNo" :disabled="true"></el-input>
                    </el-form-item>
...
<!--                    <el-form-item label="客户">-->
<!--                        <el-select v-model="model.customer" value-key="id">-->
<!--                            <el-option v-for="item of customers"-->
<!--                                       :key="item.id"-->
<!--                                       :label="item.username"-->
        ...
        methods: {
            ...
            async save() {
                ...
                if (this.id) {
                    ...
                    res = await this.$http.post("saleOrder/add", this.model);
                }
